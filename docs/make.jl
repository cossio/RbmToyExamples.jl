...
import RbmToyExamples

ENV["JULIA_DEBUG"] = "Documenter,Literate,RestrictedBoltzmannMachines,RbmToyExamples"
...
=#
Documenter.makedocs(
    modules = [RbmToyExamples],
    sitename = "RbmToyExamples.jl",
    pages = [
        "Home" => "index.md",
        "Toy Examples" => [
            "Two modes" => "literate/toy_examples/two_modes.md",
        ],
...
Documenter.deploydocs(
    repo = "github.com/cossio/RbmToyExamples.jl.git",
    devbranch = "master"
)
